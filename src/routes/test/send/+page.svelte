                ...
                <div class="half fill">
                    <div class="row">
                        <div class="group">
                            ...
                            <br>
                            <select name="profile" id="profile" title="Start" bind:value={$profile} on:change|preventDefault={() => updateVals()}>
                        ...
                        <div class="group">
                            ...
                            <br />
                            <select name="destination" id="destination" title="Destination" bind:value={destination} on:change|preventDefault={() => updateVals()}>
                                {#each Object.keys(data.planets) as planet}
                                    <option value={planet}>{planet}</option>
                                {/each}
                            </select>
